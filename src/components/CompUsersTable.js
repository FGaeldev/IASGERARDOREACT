...
export default function UsersTable() {
  ...
  //LOAD tbl_accounts
  function fetchTable() {
    fetch("https://gerardo.augusta2026.online/api/users_table.php", {
      method: "POST",
      headers: {
  ...
  const handleRoleChange = async (id, newRole) => {
    ...
    try {
      const res = await fetch("https://gerardo.augusta2026.online/api/update_role.php", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleUserDelete = async (id, email) => {
    const prevUsers = [...users];
    try {
      const res = await fetch("https://gerardo.augusta2026.online/api/delete_user.php", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
