...
export default function UsersTable() {
  ...
  //LOAD tbl_accounts
  function fetchTable() {
    fetch("http://localhost/IAS/IASPhp/users_table.php", {
      method: "POST",
      headers: {
  ...
  const handleRoleChange = async (id, newRole) => {
    ...
    try {
      const res = await fetch("http://localhost/IAS/IASPhp/update_role.php", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleUserDelete = async (id, email) => {
    const prevUsers = [...users];
    try {
      const res = await fetch("http://localhost/IAS/IASPhp/delete_user.php", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
